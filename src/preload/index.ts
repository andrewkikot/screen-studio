...
const api = {
  ...
  getPickerShot: (): Promise<unknown> => ipcRenderer.invoke('picker:get-shot'),
  pickColor: (hex: string): Promise<boolean> => ipcRenderer.invoke('picker:pick', hex),
  cancelPicker: (): Promise<void> => ipcRenderer.invoke('picker:cancel'),
